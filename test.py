...
# before the 5th max-pooling layer in VGG19. This is layer 20 in the corresponding Keras model.
...
# 200,000 steps and learning rate is reduced from 1e-4 to 1e-5 after 100,000 steps
...
#resolve_and_plot(edsr_pre_trained, edsr_fine_tuned, 'demo/roosevelt.png')
resolve_and_plot(edsr_pre_trained, edsr_fine_tuned, 'demo/qingting2-tuya.png') #error
plt.show()
